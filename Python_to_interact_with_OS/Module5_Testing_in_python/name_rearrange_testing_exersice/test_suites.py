...
ORIGINAL_FILE_PATH = "/tmp/oroginal_text_file.txt"
COPIED_FILE_PATH = "/mnt/data/copied_test_file.txt"

#Global counter
COUNTER = 0

#this method will be run once before any test or test classes
def setUpModule():
    global COUNTER
    COUNTER = 0
...
class TestSimpleAddition(unittest.TestCase):
	...
	def tearDown(self):# Append the test result to the file
